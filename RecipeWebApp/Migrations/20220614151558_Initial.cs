    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RecipeUserMappings", x => x.Id);
                    table.UniqueConstraint("AK_RecipeUserMappings_UserId_RecipeId", x => new { x.UserId, x.RecipeId });
                    table.ForeignKey(
                        name: "FK_RecipeUserMappings_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RecipeUserMappings_Recipes_RecipeId",
                        column: x => x.RecipeId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RecipeUserMappings_RecipeId",
                table: "RecipeUserMappings",
                column: "RecipeId");
        }
